...
<br>
<center>
<form method="post" name="writeform" action="/Board/review_board/writePro.do" onsubmit="return writeSave()">
...
<td colspan=2 bgcolor="${value_c }" align="center">
  ...
  <input type="button" value="취소" OnClick="window.location='/Board/review_board/list.do'">
</td></tr></table>   
