...
<html>
    ...
    <body>
		...
		<hr>
		<section>
			<div class="submenu">고객센터</div>
			<nav>
				<a href="/ChaChaCha/clientCenter/notice/list.do" target="_self">공지사항</a><hr/>
				<a href="/ChaChaCha/clientCenter/qna_board/list.do" target="_self">Q&A</a><hr/>
			</nav>
