...
<br>
<center>
<form method="post" name="writeform" action="/clientCenter/notice/updatePro.do?pageNum=${pageNum}"
  ...
  <tr>     
   <td colspan=2 bgcolor="${value_c}" align="center">
     ...
     <input type="button" value="취소"
       onclick="document.location.href='/clientCenter/notice/list.do?pageNum=${pageNum}'">
   </td>
</tr>
