...
<body>
<form method="post" name="mail_frm"  id="mail_frm" enctype="multipart/form-data" onSubmit="return ok()" action="/ChaChaCha/logon/createUserPro.do">
	...
	<h6>※<label class="red">*</label>은 필수입력 항목입니다. 회원가입을 위해 반드시 기입해 주십시오.</h6>
			...
			<tr>
				...
				<input type="button" value="취소"	 onclick="javascript:window.location='/ChaChaCha/logon/loginForm.do'"></td>
			</tr>
		</table>
	</form>
</body>  
