...
<TABLE cellSpacing=1 cellPadding=1 width="260" border=1 align="center" >
  ...
  <TR height="30">
    <TD colspan="2" align="middle"  >
      ...
      <INPUT type="button" value="id/pw찾기" onclick="javascript:location='/ChaChaCha/logon/searchPwMove.do'">
      <input type="button" value="회원가입" onclick="javascript:location='/ChaChaCha/logon/createUserMove.do'"></TD></TR>
</TABLE>
</form>
