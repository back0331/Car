...
<BODY onload="begin()">
<form name="myform" action="/Logon/logon/loginPro.do" method="post" onSubmit="return checkIt()">
<TABLE cellSpacing=1 cellPadding=1 width="260" border=1 align="center" >
  ...
  <TR height="30">
    <TD colspan="2" align="middle"  >
      ...
      <input type="button" value="회원가입" onclick="javascript:location='/Logon/logon/createUserForm.do'"></TD></TR>
</TABLE>
</form>
